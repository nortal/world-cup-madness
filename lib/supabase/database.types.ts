...
export type Database = {
  ...
  public: {
    ...
    Functions: {
      ...
      reconcile_teams_notifications: { Args: never; Returns: undefined }
      reconcile_teams_notifications_now: { Args: never; Returns: undefined }
      record_auth_failure: {
        Args: {
          p_action: string
      ...
      runtests:
        | { Args: never; Returns: string[] }
        | { Args: { "": string }; Returns: string[] }
      scrub_pii_for_teams: { Args: { input: string }; Returns: string }
